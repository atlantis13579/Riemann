...
public:
	...
	virtual bool AddLines(const char* Id, Transform* pTrans, const Vertex1* pVerties, int nVerties, const void* pIndices, int nIndices) = 0;
	...
	virtual void AddConvexMesh(ConvexMesh* mesh, Transform* Trans) = 0;
