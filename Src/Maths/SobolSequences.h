...
inline int i4_bit_hi1 ( int n );
inline int i4_bit_lo0 ( int n );
inline int i4_max ( int i1, int i2 );
inline int i4_min ( int i1, int i2 );
inline void i4_sobol ( int dim_num, int *seed, float quasi[ ] );
inline float *i4_sobol_generate ( int m, int n, int skip );
inline int i4_uniform ( int b, int c, int *seed );

inline int i8_bit_hi1 ( long long int n );
inline int i8_bit_lo0 ( long long int n );
inline long long int i8_max ( long long int i1, long long int i2 );
inline long long int i8_min ( long long int i1, long long int i2 );
inline void i8_sobol ( int dim_num, long long int *seed, double quasi[ ] );
inline double *i8_sobol_generate ( int m, int n, int skip );
inline long long int i8_uniform ( long long int b, long long int c, int *seed );

inline float r4_abs ( float x );
inline int r4_nint ( float x );
inline float r4_uniform_01 ( int *seed );
...
inline int tau_sobol ( int dim_num );
...
//
    if ( dim_num < 1 || DIM_MAX2 < dim_num )
    {
      ...
      throw std::runtime_error("I4_SOBOL invalid dimension.");
    }
...
//
  if ( maxcol < l )
  {
    ...
    cout << "  MAXCOL = " << maxcol << "\n";
    cout << "  L =      " << l << "\n";
    throw std::runtime_error("I4_SOBOL seed is too large.");
  }
//
...
inline int i4_uniform ( int a, int b, int *seed )
...
//
{
  ...
  if ( *seed == 0 )
  {
    ...
    throw std::runtime_error("I4_UNIFORM seed must not be zero.");
  }
...
//
    if ( dim_num < 1 || DIM_MAX2 < dim_num )
    {
      ...
      cout << "    1 <= DIM_NUM <= " << DIM_MAX2 << "\n";
      cout << "  But this input value is DIM_NUM = " << dim_num << "\n";
      throw std::runtime_error("I8_SOBOL invalid dimension.");
    }
...
//
  if ( maxcol < l )
  {
    ...
    cout << "  MAXCOL = " << maxcol << "\n";
    cout << "  L =      " << l << "\n";
    throw std::runtime_error("I8_SOBOL seed is too large.");
  }
//
//  Calculate the new components of QUASI.
//  The caret indicates the bitwise exclusive OR.
...
inline long long int i8_uniform ( long long int a, long long int b, int *seed )
...
//
{
  ...
  if ( *seed == 0 )
  {
    ...
    cerr << "  Input value of SEED = 0.\n";
    throw std::runtime_error("I8_UNIFORM seed must not be zero.");
  }
...
//
{
  ...
  if ( *seed == 0 )
  {
    ...
    cerr << "  Input value of SEED = 0.\n";
    throw std::runtime_error("R4_UNIFORM_01 seed must not be zero.");
  }
...
//
{
  ...
  if ( *seed == 0 )
  {
    ...
    cerr << "  Input value of SEED = 0.\n";
    throw std::runtime_error("R8_UNIFORM_01 seed must not be zero.");
  }
...
inline void r8mat_write ( string output_filename, int m, int n, double table[] )
